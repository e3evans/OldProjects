...
<form method="POST"  action=relatedurldisplay.htm>
	<table border=0 >
		<tr>
	...
	<tr>
	   <td>
		...
		<input type=radio name=fieldname value="ThreadID" />ThreadID
	...
	<tr>
		<td><b>fieldvalue</b> <font color=red> *Required.  </font> .ico value
		<blockquote>
	...
	<tr>
		<td><b>relatedTofieldname</b> <font color=red> *Required.  </font> .
		<blockquote>
		<input type=radio name=relatedto value="bug" checked />Bug
		<input type=radio name=relatedto value="url"  />url
		<input type=radio name=relatedto value="sw-image-names"  />SWimage
		<input type=radio name=relatedto value="pid" />PIDs
		<input type=radio name=relatedto value="errmsg"  />Error Messages
		<input type=radio name=relatedto value="mib"  />MIBs
		<input type=radio name=relatedto value="rfc" />RFCs
		<input type=radio name=relatedto value="c3case"  />C3Case
		<input type=radio name=relatedto value="serial_no"  />SerialNumber
		<b>non-ICOs</b>
		<input type=radio name=relatedto value="userid" />userid
	    <input type=radio name=relatedto value="MDFID" />MDFID
		<input type=radio name=relatedto value="C3Workgroup" />C3Workgroup
		<input type=radio name=relatedto value="Community" />Community
		<input type=radio name=relatedto value="ThreadID" />ThreadID
		<input type=radio name=relatedto value="Tech/Subtech" />Tech/Subtech
		</blockquote>
		</td>
	</tr>

        <tr>
                <td><b>relatednessThreshold</b> <font color=red> </font> 
                <blockquote>
