...
public class App implements Serializable {
	...
	/*
	 * public static final String ACTIVE = "A"; public static final String
	 * INACTIVE = "I"; public static final String BOTH = "B"; public static
	 * final String NO_NON_EMPLOYEES = "N"; public static final String
	 * ONLY_INTERNAL = "I"; public static final String ONLY_EXTERNAL = "E";
	 * public static final String ONLY_SECURED = "S"; public static final String
	 * ONLY_UNSECURED = "U"; public static final String ONLY_RESTRICTED = "R";
	 * public static final String ONLY_UNRESTRICTED = "U"; public static final
	 * String ACCESS_DEFAULT = "D"; public static final String ACCESS_MENU =
	 * "M"; public static final String ACCESS_RESTRICTED = "R"; public static
	 * final String ACCESS_NOACCESS = "N"; public static final String
	 * ACCESS_EXECUTE = "E";
	 */
	...
	/*
	 * public String getAppId() { if(getAppKey() != null) { return
	 * getAppKey().getAppId(); } else { return null; } }
	 * 
	...
	/*
	 * public String getAdjName() { int cur = 0; String adjName; for(adjName =
	 * appName.trim(); adjName.indexOf("'", cur) > -1; cur++) { cur =
	 * adjName.indexOf("'", cur); if(adjName.length() > cur) { adjName = (new
	 * StringBuilder()).append(adjName.substring(0,
	 * cur)).append("\\'").append(adjName.substring(cur + 1)).toString(); } else
	 * { adjName = (new StringBuilder()).append(adjName.substring(0,
	 * cur)).append("\\'").toString(); } cur++; }
	 * 
	 * return adjName; }
	 */

	/*
	 * public String getAppNameEncoded() { String encoded = appName; try {
	 * encoded = URLEncoder.encode(appName, "UTF-8"); }
	 * catch(UnsupportedEncodingException e) { System.out.println(e); } return
	 * encoded;
	 */
